...
\todo{create a simplified copy in a better fitting style(i didn't understand, copy from what?)}
...
\todo{move client information to this chapter???(i suggest to not move)}
